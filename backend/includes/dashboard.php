...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            <div class="sidebar-brand-icon rotate-n-15" style="background-color: white">
                <img src="/assets/images/logo.png" alt="">
            </div>
            <div class="sidebar-brand-text mx-3">Sewaganj</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header"></h6>
                    <a class="collapse-item" href="/admin/services">Available Services</a>
                    <a class="collapse-item" href="/admin/services-category">Add New Services</a>
                </div>
            </div>
        </li>
